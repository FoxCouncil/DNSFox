...
namespace PresentationControls
{
    ...
    public partial class CheckBoxComboBox : PopupComboBox
    {
        ...
        public CheckBoxComboBox() : base()
        {
            ...
            // The resizing is stupid, because the stupid popup can be user sized to a graphene thick line of windows control fail. - Fox
            ...
            // This resizing bullshit is re-donk-culous! There is no need to excel at being teh worst.
            // Whiners Complain About Their Best, Winners Go Home and Fuck The Prom King
        ...
        internal string GetCSVText(bool skipFirstItem)
        {
            ...
            int StartIndex = (DropDownStyle == ComboBoxStyle.DropDownList && DataSource == null && skipFirstItem) ? 1 : 0;
